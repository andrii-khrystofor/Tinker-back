...
{
    public partial class Tinker_DBContext : DbContext
    {
        public Tinker_DBContext()
        {
        }

        public Tinker_DBContext(DbContextOptions<Tinker_DBContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<UserToChat> UserToChats { get; set; } = null!;
